...
const required = [
  ...
  ['request coalescing at bounded work boundaries', renderer, 'if (this.latestRequest) break'],
  ['bounded asynchronous submission depth', renderer, 'MAX_IN_FLIGHT_BATCHES'],
